    ...
    <div class="navbar-header">
      ...
      <div class="d-flex">
        ...
        <BDropdown class="d-inline-block" toggle-class="header-item" right variant="white">
          <template v-slot:button-content>
            <img class="rounded-circle header-profile-user" src="@/assets/images/users/shaun.png"
              alt="Header Avatar" />
            <span class="d-none d-xl-inline-block ms-1 fw-medium font-size-15">Shaun Rampersad</span>
...
<!--DASHBOARD IS RENDERED HERE-->

    <BContainer fluid>
      <div style="background-color: rgb(79, 160, 241);" class="topnav">
